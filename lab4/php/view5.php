...
<body>
  ...
  <div id="content" style="background-color:white">
    <div class="big">
      <img src="../images/card.jpg" width="350px" height="350px">
      <br><BR><Br><br>
        <p>
        <span id= "itemname"> Christmas Cards <br><br> </span>
        <span id="price"> Price </span> : GHS 6.50 for 1 <BR><BR>
          <span id="description"> Description </span>: This is one of many christmas cards in stock.
          <br> <br> Each of these have been specially handcrafted with the finest materials. <br><br>
          <span id="quantity"> Quantity in Stock </span>: 100 <br><br>
