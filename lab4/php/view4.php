...
<body>
  ...
  <div id="content" style="background-color:white">
    <div class="big">
      ...
      <br><BR><Br><br>
        <p>
        <span id= "itemname"> Ball Ornament with Shepherds Decoration <br><br> </span>
        <span id="price"> Price </span> : GHS 10.00 per ball <BR><BR>
          <span id="description"> Description </span>: This is a ball ornament with shepherds designed into the covering.
          <br> <br> Suitable for hanging on trees and lights. <br><br>
          <span id="quantity"> Quantity in Stock </span>: 30 <br><br>
