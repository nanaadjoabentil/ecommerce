...
<body>
  ...
  <div id="content" style="background-color:white">
    <div class="big">
      <img src="../images/candle.jpg" width="350px" height="350px">
      <br><BR><Br><br>
        <p>
        <span id= "itemname"> Candle <br><br> </span>
        <span id="price"> Price </span> : GHS 18.00 per pack of 2 <BR><BR>
          <span id="description"> Description </span>: This is a scented candle with mistletoe decoration at the base.
          <br> <br>
          <span id="quantity"> Quantity in Stock </span>: 18 <br><br>
