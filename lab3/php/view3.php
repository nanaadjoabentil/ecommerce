...
<body>
  ...
  <div id="content" style="background-color:white">
    <div class="big">
      <img src="../images/wreath.jpg" width="350px" height="350px">
      <br><BR><Br><br>
        <p>
        <span id= "itemname"> Christmas Wreath <br><br> </span>
        <span id="price"> Price </span> : GHS 35.00 <BR><BR>
          <span id="description"> Description </span>: This is a christmas wreath delicately interwoven with green and red colours and acorns.
          <br> <br> Suitable for hanging on doors. <br><br>
